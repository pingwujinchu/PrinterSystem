...
var __parent0=require('$model/UI2/Print/loginActivity'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='cyYzMVv';
	this._flag_='5bdfd65a66dbfca30e8344e9d793eda4';
	this.callParent(contextUrl);
 require('res!$UI/Print/fonts');
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":false,"defCols":{"calcCheckBox":{"define":"calcCheckBox","label":"选择","name":"calcCheckBox","relation":"calcCheckBox","type":"Boolean"},"fID":{"define":"fID","label":"mainData","name":"fID","relation":"fID","rules":{"calculate":"justep.UUID.createUUID()"},"type":"String"}},"directDelete":true,"events":{"onCustomRefresh":"mainDataCustomRefresh"},"idColumn":"fID","limit":20,"xid":"mainData"});
}}); 
return __result;});

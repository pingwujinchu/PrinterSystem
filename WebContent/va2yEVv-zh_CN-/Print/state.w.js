...
var __parent0=require('$model/UI2/Print/state'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__cid='cmyQbua';
	this._flag_='a223b67470e7d6aa180eb5d537af6d5d';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"calBut":{"define":"calBut","label":"calBut","name":"calBut","relation":"calBut","type":"Boolean"},"fileName":{"define":"fileName","label":"fileName","name":"fileName","relation":"fileName","type":"String"},"jID":{"define":"jID","label":"jobID","name":"jID","relation":"jID","type":"String"},"state":{"define":"state","label":"state","name":"state","relation":"state","type":"String"},"time":{"define":"time","label":"time","name":"time","relation":"time","rules":{"datetime":true},"type":"DateTime"}},"directDelete":false,"events":{"onCustomRefresh":"taskDataCustomRefresh"},"idColumn":"jID","limit":20,"xid":"taskData"});
 new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"userID":{"define":"userID","label":"userID","name":"userID","relation":"userID","type":"String"}},"directDelete":false,"events":{},"idColumn":"userID","limit":20,"xid":"userData"});
}}); 
return __result;});
